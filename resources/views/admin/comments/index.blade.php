...
$pageName = $attributesName['manage'] . " " . $attributesName['comments'];
            ...
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="{{ route('admin.comments.create') }}"
                       class="btn btn-info btn-sm">{{ $attributesName['create'] ." ". $attributesName['comment'] . " ".$attributesName['new'] }}</a>
                            ...
                            <tr>
                                ...
                                <td class="width-22-rem text-left">
                                    ...
                                    <a id="statusb-{{ $model->id }}" class="btn btn-warning btn-sm"
                                       ...
                                       data-url="{{ route('admin.comments.status', $model->id) }}">
                                        <i class="fa fa-undo "></i>
                                    </a>

                                    <a href="{{ route('admin.comments.edit', $model->id) }}"
                                       class="btn btn-primary btn-sm"><i
                                            class="fa fa-edit"></i> {{ $attributesName['edit'] }}</a>
                                    <form class="d-inline"
                                          action="{{ route('admin.comments.destroy', $model->id) }}"
                                          method="post">
                                        @csrf
                                        {{ method_field('delete') }}

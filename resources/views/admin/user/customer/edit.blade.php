...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> {{ $attributesName['edit']." ". $attributesName['user']." ".$attributesName['userLabel'] }}</li>
        </ol>
    </nav>
        ...
        <section class="col-12">
            <section class="main-body-container">
                <section class="main-body-container-header">
                    <h5>
                        {{ $attributesName['edit']." ". $attributesName['user']." ".$attributesName['userLabel'] }}
                    </h5>
                </section>
                ...
                <section>
                    <form action="{{ route('admin.user.customer.update', $model->id) }}" method="post"

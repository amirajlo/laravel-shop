...
@section('head-tag')
    <title>
        ...
        {{ $attributesName['manage'] ." ". $attributesName['tags'] }}
    </title>
@endsection
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active"
                aria-current="page">{{ $attributesName['tags'] }}</li>
        </ol>
    </nav>
            ...
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="{{ route('admin.tags.create') }}"
                       class="btn btn-info btn-sm">{{ $attributesName['create'] ." ". $attributesName['tag'] . " ".$attributesName['new'] }}</a>
                        ...
                        @foreach ($models as $key => $model)
                            ...
                            <tr>
                                ...
                                <td class="width-22-rem text-left">
                                    ...
                                    <form class="d-inline"
                                          action="{{ route('admin.tags.destroy', $model->id) }}"
                                          method="post">
                                        @csrf
                                        {{ method_field('delete') }}
